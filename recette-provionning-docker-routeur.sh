...
read
# 1./ configurer les repos de docker-ce
...
# vérification de la clé du repo
sudo apt-key fingerprint 0EBFCD88 >> verif-empreinte-repo.7zunft
# la vérificatione est acquise si et ssi le fichier "verif-empreinte-repo.7zunft" contient la chaîne de caractères :
