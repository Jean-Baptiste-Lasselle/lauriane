...
# opérations 
sudo docker run --name $NOM_CONTENEUR_SRV_DHCP_USINE_LOGICIELLE --ip=$ADRESSE_IP_INTERFACE_RESEAU_USINE_LOGICIELLE  -d $NOM_IMAGE_DOCKER_ZUNFT_DHCP_SERVER:$VERSION_IMAGE_DOCKER_ZUNFT_DHCP_SERVER
sudo docker run --name $NOM_CONTENEUR_SRV_DHCP_CIBLE_DEPLOIEMENT --ip=$ADRESSE_IP_INTERFACE_RESEAU_CIBLE_DEPLOIEMENT  -d $NOM_IMAGE_DOCKER_ZUNFT_DHCP_SERVER:$VERSION_IMAGE_DOCKER_ZUNFT_DHCP_SERVER
sudo docker run --name $NOM_CONTENEUR_SRV_DHCP_MACHINES_PHYSISQUES --ip=$ADRESSE_IP_INTERFACE_RESEAU_MACHINES_PHYSISQUES  -d $NOM_IMAGE_DOCKER_ZUNFT_DHCP_SERVER:$VERSION_IMAGE_DOCKER_ZUNFT_DHCP_SERVER
