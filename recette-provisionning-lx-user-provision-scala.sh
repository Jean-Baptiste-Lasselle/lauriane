...
# echo "$MVN_PLUGIN_OPERATEUR_LINUX_USER_NAME ALL=NOPASSWD:SETENV $CONFIG_SUDOERS_A_APPLIQUER_AC_SETENV, NOPASSWD: $CONFIG_SUDOERS_A_APPLIQUER" >> $PROVISIONNING_HOME/sudoers.provision-scala-fullstack.ajout
echo "$MVN_PLUGIN_OPERATEUR_LINUX_USER_NAME ALL=($MVN_PLUGIN_OPERATEUR_LINUX_USER_NAME:$MVN_PLUGIN_OPERATEUR_LINUX_USER_NAME) NOPASSWD:SETENV $CONFIG_SUDOERS_A_APPLIQUER_AC_SETENV, NOPASSWD: $CONFIG_SUDOERS_A_APPLIQUER" >> $PROVISIONNING_HOME/sudoers.provision-scala-fullstack.ajout
echo "" >> $PROVISIONNING_HOME/sudoers.provision-scala-fullstack.ajout
